require 'rails_helper'
 ...
 RSpec.describe Api::V1::PostsController, type: :controller do
   ...
   let(:my_post) { create(:post, title: "Post Title", body: "There once was a frog who lived in a bog and he played the bass fiddle in the middle of a puddle.", topic_id: my_topic.id, user_id: my_user.id) }
